...
const page = () => {
  return (
    <div className="max-w-[1400px] mx-auto text-black flex flex-col md:flex-row p-4 gap-4">
      ...
      <div className="w-1/3 mx-auto p-2 bg-gray-100 shadow-md sticky top-20 h-[calc(100vh-140px)]">
        <Image
