        ...
        <div className="bg-white rounded-md p-2 flex items-start gap-4 shadow-lg text-black">
          ...
          <div className="flex-1">
            ...
            <p className="line-clamp-3 text-sm text-gray-700">
              ...
              कार्यक्रम सन्चालन गर्दै आएकोमा मोहरिया सेवाकेन्द्र अन्तर्गतका
              आफ्ना सदस्यहरुलाई मिति २०७८ पौष २३ गते सदस्य शिक्षा तालिम प्रदान
              गरेको छ । संस्थाका सञ्चालक समितिका अध्यक्ष रुद्रकुमारी गुरुङ्गको
              अध्यक्षतामा सम्पन्न भएको उक्त कार्यक्रममा संस्थाका कोषाध्यक्ष तथा
              शिक्षा उपसमिति संयोजक गीर बहादुर श्रेष्ठ, सन्चलाक
            </p>
          </div>
        </div>
      </Link>
