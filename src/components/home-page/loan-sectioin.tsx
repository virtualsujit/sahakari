...
const LoanSection = () => {
  ...
  return (
    <div className="bg-gray-100 text-black py-6 space-y-6">
      <div className="flex items-center justify-center gap-2">
        <div className="border-2 bg-[#32488A] p-1 rounded-lg w-9" />
        <h2 className="text-2xl">Loans</h2>
        <div className="border-2 bg-[#32488A] p-1 rounded-lg w-9" />
      </div>
      <p className="text-center">Variety of loans that will suit your needs</p>
      ...
      <p className="bg-green-600 rounded-full text-white px-2   text-center">view all</p>
      </div>
    </div>
  );
};
